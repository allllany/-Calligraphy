...
public class Duibi_xingshuActivity04 extends AppCompatActivity {


    private ImageView xingshu04_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duibi_xingshu04);
        initview();
    }

    public void initview() {

        xingshu04_add = findViewById(R.id.addPic);
        xingshu04_add.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        startCompare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (xingshu04_add.getDrawable().getCurrent().
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                xingshu04_add.setImageBitmap(bitmap);


                Bitmap bitmap1 = BitmapUtils.decodeSampledBitmapFromResource(getResources(),
                        R.drawable.xingshu_duibi04,
                        xingshu04_add.getWidth(),
                        xingshu04_add.getHeight());
...
//            根据uri重新获取流，inputstream在解析中发生改变了
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.duibi_xingshu_iv_back:
                finish();
                break;
        }
    }
