...
public class Duibi_lishuActivity02 extends AppCompatActivity {



    private ImageView lishu02_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duibi_lishu02);
        initview();
    }
    ...
    public void initview() {
        ...
        lishu02_add = findViewById(R.id.addPic);
        lishu02_add.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        startCompare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lishu02_add.getDrawable().getCurrent().
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                lishu02_add.setImageBitmap(bitmap);


                Bitmap bitmap1 = BitmapUtils.decodeSampledBitmapFromResource(getResources(),
                        R.drawable.lishu_duibi02,
                        lishu02_add.getWidth(),
                        lishu02_add.getHeight());
...
//            根据uri重新获取流，inputstream在解析中发生改变了
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.duibi_lishu02_iv_back:
                finish();
                break;
        }
    }
