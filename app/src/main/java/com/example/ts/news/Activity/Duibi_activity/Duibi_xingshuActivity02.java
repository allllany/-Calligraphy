...
public class Duibi_xingshuActivity02 extends AppCompatActivity {

    private ImageView xingshu02_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duibi_xingshu02);
        initview();
    }

    public void initview() {

        xingshu02_add = findViewById(R.id.addPic);
        xingshu02_add.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        startCompare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (xingshu02_add.getDrawable().getCurrent().
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                xingshu02_add.setImageBitmap(bitmap);


                Bitmap bitmap1 = BitmapUtils.decodeSampledBitmapFromResource(getResources(),
                        R.drawable.xingshu_duibi02,
                        xingshu02_add.getWidth(),
                        xingshu02_add.getHeight());
...
//            根据uri重新获取流，inputstream在解析中发生改变了
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.duibi_xingshu02_iv_back:
                finish();
                break;
        }
    }
