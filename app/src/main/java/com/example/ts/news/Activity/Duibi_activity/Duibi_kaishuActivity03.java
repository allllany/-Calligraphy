...
public class Duibi_kaishuActivity03 extends AppCompatActivity {
    private ImageView kaishu03_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duibi_kaishu03);
        initview();
    }

    public void initview() {

        kaishu03_add = findViewById(R.id.addPic);
        kaishu03_add.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        startCompare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (kaishu03_add.getDrawable().getCurrent().
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                kaishu03_add.setImageBitmap(bitmap);


                Bitmap bitmap1 = BitmapUtils.decodeSampledBitmapFromResource(getResources(),
                        R.drawable.kaishu_duibi03,
                        kaishu03_add.getWidth(),
                        kaishu03_add.getHeight());
...
//            根据uri重新获取流，inputstream在解析中发生改变了
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.duibi_kaishu03_iv_back:
                finish();
                break;
        }
    }
