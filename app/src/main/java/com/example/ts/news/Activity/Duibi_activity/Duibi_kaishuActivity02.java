...
import com.example.ts.news.Utils.CompareUtils;
...
public class Duibi_kaishuActivity02 extends AppCompatActivity {


    private ImageView kaishu02_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duibi_kaishu02);
        initview();
    }

    public void initview() {

        kaishu02_add = findViewById(R.id.addPic);
        kaishu02_add.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        startCompare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (kaishu02_add.getDrawable().getCurrent().
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                kaishu02_add.setImageBitmap(bitmap);


                Bitmap bitmap1 = BitmapUtils.decodeSampledBitmapFromResource(getResources(),
                        R.drawable.kaishu_duibi02,
                        kaishu02_add.getWidth(),
                        kaishu02_add.getHeight());
...
//            根据uri重新获取流，inputstream在解析中发生改变了
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.duibi_kaishu02_iv_back:
                finish();
                break;
        }
    }
