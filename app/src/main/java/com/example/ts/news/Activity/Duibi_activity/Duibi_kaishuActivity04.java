...
public class Duibi_kaishuActivity04 extends AppCompatActivity {
    private ImageView kaishu04_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duibi_kaishu04);
        initview();
    }
    ...
    public void initview() {
        ...
        kaishu04_add = findViewById(R.id.addPic);
        kaishu04_add.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        startCompare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (kaishu04_add.getDrawable().getCurrent().
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                kaishu04_add.setImageBitmap(bitmap);


                Bitmap bitmap1 = BitmapUtils.decodeSampledBitmapFromResource(getResources(),
                        R.drawable.kaishu_duibi04,
                        kaishu04_add.getWidth(),
                        kaishu04_add.getHeight());
...
//            根据uri重新获取流，inputstream在解析中发生改变了
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.duibi_kaishu04_iv_back:
                finish();
                break;
        }
    }
