...
public class Duibi_lishuActivity01 extends AppCompatActivity {
    private ImageView lishu01_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duibi_lishu01);
        initview();
    }
    ...
    public void initview() {
        ...
        lishu01_add = findViewById(R.id.addPic);
        lishu01_add.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        startCompare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lishu01_add.getDrawable().getCurrent().
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                lishu01_add.setImageBitmap(bitmap);


                Bitmap bitmap1 = BitmapUtils.decodeSampledBitmapFromResource(getResources(),
                        R.drawable.lishu_duibi01,
                        lishu01_add.getWidth(),
                        lishu01_add.getHeight());
