...
public class Duibi_xingshuActivity01 extends AppCompatActivity {

    private ImageView xingshu01_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duibi_xingshu);
        initview();
    }
    ...
    public void initview() {
        ...
        xingshu01_add = findViewById(R.id.addPic);
        xingshu01_add.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        startCompare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (xingshu01_add.getDrawable().getCurrent().
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                xingshu01_add.setImageBitmap(bitmap);


                Bitmap bitmap1 = BitmapUtils.decodeSampledBitmapFromResource(getResources(),
                        R.drawable.xingshu_duibi01,
                        xingshu01_add.getWidth(),
                        xingshu01_add.getHeight());
